...
OUTPUT_DIR       = str(SCRIPT_DIR / 'thermamnerf_outputs2.5')
...
CFG = {
    ...
    'lr'              : 5e-4,
    'lambda_dice'     : 1.0,
    'lambda_bg'       : 5.0,     # Lowered to protect LL tip
    'lambda_thermal'  : 0.0,
    'lambda_tv'       : 0.01,    # Strong enough to keep edges smooth
    'lambda_entropy'  : 0.05,    # Gentle snap to remove streaks without pixelating edges
    'n_rays'          : 4096,
