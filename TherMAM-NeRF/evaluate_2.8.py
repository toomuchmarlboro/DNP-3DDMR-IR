...
OUTPUT_DIR       = str(SCRIPT_DIR / 'thermamnerf_outputs2.8')
...
CFG = {
    ...
    'lr'              : 5e-4,
    'lambda_dice'     : 1.0,
    'lambda_bg'       : 5.0,     # Lowered to 5.0 to prevent early collapse
    ...
    'lambda_entropy'  : 0.5,     # Forces opacity to be 0 or 1, making surfaces completely solid
    'n_rays'          : 3072,
...
# --- Training Section Removed for Plotting Script ---
if IS_MAIN:
    print("Initializing Standalone Evaluation & Plotting Mode...")
...
# ── Training Curves (Removed for Plotting Script) ──
